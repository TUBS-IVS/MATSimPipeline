...
def run_hoerl(population_df, target_locations):
    ...
    logger.info("Hoerl done, writing to population df")
...
#             "algorithms_to_run": ['nothing'],
#             # prepend "load_" to load intermediate results
...
#             "max_iterations_complex_case": 30,
...
def main():
    ...
    #     # "advanced_petre.number_of_branches": [2,5,10],
    #     # "advanced_petre.min_candidates_complex_case": [1,200],
    #     # "advanced_petre.candidates_two_leg_case": [1,200],
    #     # "advanced_petre.max_candidates": [None, 1,100],
    #     # "advanced_petre.anchor_strategy": ["lower_middle", "upper_middle"], # start and end are VERY slow
    #     "selection_strategy_complex_case": ["keep_all", 'mixed'],
    #     # "selection_strategy_two_leg_case": ["top_n", "monte_carlo"],
    #     # "max_radius_reduction_factor": [None, 0.5, 0.9],
    # }
    ...
    df.to_csv("structured_evaluation_result_invalidandvalidmainandopenunplaced_petre_additionalones.csv", index=False)
